...
<table id="dg" title="Administrador de item evento" class="easyui-datagrid" style="width:1200px;height:500px"
    url = "../principal/principal.php?controller=AbmEvento&action=listar"  toolbar="#toolbar" pagination="true"rownumbers="true" fitColumns="true" singleSelect="true">
            <thead>
            <tr>
            ...
            function newUser(){
                ...
                $('#fm').form('clear');
                 ...
                 url = '../principal/principal.php?controller=AbmEvento&action=alta';
            }
            function editUser(){
                ...
                if (row) {
                    ...
                    url = '../principal/principal.php?controller=AbmEvento&action=editar&id='+row.id;
                }
            }
            function saveUser(){
                //alert(" Accion");
            ...
            function destroyUser(){
                ...
                if (row){
                    $.messager.confirm('Confirm','Seguro que desea eliminar el evento?', function(r){
                        if (r){
                            $.post('../principal/principal.php?controller=AbmEvento&action=baja&id='+row.id,{id:row.id},
                               function(result){
                                 if (result.respuesta){
